...
Hyphae Transformer is an independent clean implementation inspired by:
...
Hyphae Transformer does not copy the original PyTorch 1.4 implementation. It reimplements
...
attribution. Hyphae Transformer is not an official continuation of ReZero, Practical NLP,
Ai2, or Asta.
