#!/usr/bin/env python3
"""Run the live Hyphae depth-3 navigation canary with the bounded-bias ReZero pilot v4."""
...
REPORT_SCHEMA_V4 = "hyphae-transformer.hyphae-minilm-gemma-navigation-canary/v4"
...
def main() -> int:
    base.REPORT_SCHEMA = REPORT_SCHEMA_V4
    ...
    base._write_json(
        ...
        {"schema": REPORT_SCHEMA_V4, "completed": False},
    )
    daemon = None
    try:
