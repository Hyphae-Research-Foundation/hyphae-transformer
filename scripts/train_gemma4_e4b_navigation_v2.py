#!/usr/bin/env python3
"""Train the preregistered ReZero neuropilot v2 over calibrated navigation trajectories."""
...
def main() -> int:
    ...
    if arguments.calibration != HYPHAE_210_SCORE_SCALE:
        raise SystemExit("navigation v2 calibration is pinned to the Hyphae 2.1.0 scale")
