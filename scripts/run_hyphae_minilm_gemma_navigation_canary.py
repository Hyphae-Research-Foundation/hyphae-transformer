...
DISTRACTOR = (
    b"Office note: the lobby fern is watered on Tuesdays. "
    b"The mailroom logs parcel weights each morning before nine. "
    b"Stairwell lamps were replaced with daylight bulbs last spring. "
    b"The greenhouse keeps its humidity near sixty one percent at dawn. "
    b"Bicycle racks were repainted during the parking resurfacing. "
    b"Kitchen shelves hold labeled jars of tea and honey. "
    b"The courtyard fountain runs on a closed loop with monthly filter swaps. "
    b"Umbrella stands sit by both exits for rainy weeks. "
    b"Recycling bins rotate between paper and glass on alternate weeks. "
    b"The notice board archives its postings at each quarter close. "
    b"Window blinds tilt east in the reading corner. "
    b"Door hinges receive oil at the start of winter. "
    b"The copy room tracks toner levels in a shared ledger. "
    b"Plant tags list watering cadence and light needs. "
    b"The lost and found drawer is inventoried on Fridays. "
    b"Coat hooks were added beside the training room. "
    b"The garden bench was sanded and resealed in June. "
    b" Spare keycards sleep in the sealed envelope by reception."
    b" The herb planter moves indoors when frost is forecast."
)
